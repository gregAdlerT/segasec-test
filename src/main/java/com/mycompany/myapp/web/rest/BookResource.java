...
public class BookResource {
    ...
    @GetMapping(value = "/books/cheap")
    public ResponseEntity<List<Book>> getCheapBooks(Pageable pageable) {
        log.debug("REST request to get a page of Cheap Books");
        Page<Book> page = bookService.findAllCheapBooks(pageable);
        System.out.println("------------------------------------");
        System.out.println(page.getTotalElements());
        page.getContent().stream().forEach(b-> System.out.println(b));
